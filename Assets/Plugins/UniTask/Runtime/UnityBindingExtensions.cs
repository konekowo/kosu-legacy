...
namespace Cysharp.Threading.Tasks
{
    public static class UnityBindingExtensions
    {
        ...
        private static async UniTaskVoid BindToCore(IUniTaskAsyncEnumerable<string> source, Text text,
        ...
        private static async UniTaskVoid BindToCore<T>(IUniTaskAsyncEnumerable<T> source, Text text,
            CancellationToken cancellationToken, bool rebindOnError)
        {
            var repeat = false;
            BIND_AGAIN:
        ...
        private static async UniTaskVoid BindToCore(IUniTaskAsyncEnumerable<bool> source, Selectable selectable,
            CancellationToken cancellationToken, bool rebindOnError)
        {
            var repeat = false;
            BIND_AGAIN:
        ...
        private static async UniTaskVoid BindToCore<TSource, TObject>(IUniTaskAsyncEnumerable<TSource> source,
