    ...
    internal static class Aggregate
    {
            ...
            Func<TSource, TSource, TSource> accumulator, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                while (await e.MoveNextAsync()) value = accumulator(value, e.Current);
                return value;
            }
            finally
            {
            ...
            Func<TSource, TSource, UniTask<TSource>> accumulator, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                while (await e.MoveNextAsync()) value = await accumulator(value, e.Current);
                return value;
            }
            finally
            {
            ...
            CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                while (await e.MoveNextAsync()) value = await accumulator(value, e.Current, cancellationToken);
                return value;
            }
            finally
            {
