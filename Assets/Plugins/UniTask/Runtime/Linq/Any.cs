...
namespace Cysharp.Threading.Tasks.Linq
{
    ...
    {
        public static UniTask<bool> AnyAsync<TSource>(this IUniTaskAsyncEnumerable<TSource> source,
        ...
        public static UniTask<bool> AnyAwaitAsync<TSource>(this IUniTaskAsyncEnumerable<TSource> source,
        ...
        public static UniTask<bool> AnyAwaitWithCancellationAsync<TSource>(this IUniTaskAsyncEnumerable<TSource> source,
    ...
    internal static class Any
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            try
            {
                if (await e.MoveNextAsync()) return true;
